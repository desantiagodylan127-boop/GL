...
export const NEW_KIT_CHARACTERS: Character[] = [
  ...
  createCharacter(
    ...
    [
      ...
      makeAbility('hondo_special_1', 'Business Opportunity', 'special', 3, 'Hutt Cartel and Smuggler allies gain Evasion Up (2 turns) and Critical Chance Up (2 turns). Hondo gains Stealth (2 turns).', ['evasion_up', 'crit_chance_up', 'stealth', 'Stealth', 'Critical Chance Up'], ['support']),
